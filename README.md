...
- [eustore.dev](https://github.com/AIBOLLINGMO/eustore) - European S3-compatible object storage. GDPR-compliant, EU-hosted (Germany & Finland), automated provisioning, crypto payments.
